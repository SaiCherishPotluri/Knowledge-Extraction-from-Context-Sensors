...
path_to_videos = "C:/Users/cpotl/OneDrive/Desktop/MC/frames/Algorithm_1_Potluri/"
...
def convert_to_csv(path_to_video):
    ...
    pd.DataFrame(csv_data, columns=columns).to_csv(path_to_video + 'Algorithm_1_Potluri.csv', index_label='Frames#')
